...
Adb.install = function(target, packagePath, opts) {
    ...
    return spawn('adb', args.concat(packagePath), {
            cwd: os.tmpdir()
        })
        .then(function(output) {
...
Adb.uninstall = function(target, packageId) {
    ...
    return spawn('adb', ['-s', target, 'uninstall', packageId], {
        cwd: os.tmpdir()
    });
};
...
Adb.shell = function(target, shellCommand) {
    ...
    return spawn('adb', args.concat(shellCommand), {
            cwd: os.tmpdir()
        })
